_base_ = [
    '../_base_/default_runtime.py', '../_base_/datasets/phonescreen.py',
    '../_base_/schedules/schedule_40k_IVD.py'
]
...
# optimizer
optimizer = dict(
    type='Adam', lr=0.0001, weight_decay=0.0001, eps=1e-8, betas=(0.9, 0.999))
optim_wrapper = dict(
    _delete_=True,
    type='OptimWrapper',
    optimizer=optimizer,
