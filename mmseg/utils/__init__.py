...
from .class_names import (ade_classes, ade_palette, bdd100k_classes,
                          ...
                          vaihingen_palette, voc_classes, voc_palette,bsdatamnist_classes,
                          bsdatamnist_palette,crackforestmnist_classes, crackforestmnist_palette,
                          mvtecadmnist_classes, mvtecadmnist_palette, magnetic_tile_classes, magnetic_tile_palette)
# yapf: enable
...
__all__ = [
    ...
    'bsdatamnist_classes',
    'bsdatamnist_palette',
    'crackforestmnist_classes',
    'crackforestmnist_palette',
    'mvtecadmnist_classes',
    'mvtecadmnist_palette',
    'magnetic_tile_palette',
    'magnetic_tile_classes'
]
