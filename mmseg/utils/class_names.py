...
def phonescreen_classes():
    """IVD class names for external use"""
    return [
        'background', 'anomaly'
    ]

def phonescreen_palette():
    return[[0,0,0],[255,255,255]]

def bsdatamnist_classes():
    """IVD class names for external use"""
    return [
        'background', 'anomaly'
    ]
def bsdatamnist_palette():
    return[[0,0,0],[255,255,255]]

def crackforestmnist_classes():
    """IVD class names for external use"""
    return [
        'background', 'anomaly'
    ]
def crackforestmnist_palette():
    return[[0,0,0],[255,255,255]]


def mvtecadmnist_classes():
    """IVD class names for external use"""
    return [
        'background', 'anomaly'
    ]
def mvtecadmnist_palette():
    return[[0,0,0],[255,255,255]]
...
dataset_aliases = {
    ...
    'bsdatamnist':['bsdatamnist'],
    'crackforestmnist':['crackforestmnist'],
    'mvtecadmnist':['mvtecadmnist']
}
